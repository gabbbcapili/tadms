                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo form_input('deposit_date', $inv->deposit_date, 'class="form-control input-tip date" id="deposit_date" required="required"'); ?>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo form_input('transaction_date', $inv->transaction_date, 'class="form-control input-tip date" id="transaction_date" required="required"'); ?>
                                </div>
                            </div>
